  ...
  static ThemeData get dark => ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(borderRadius: AppRadius.borderSm8),
      ),
    ),
    ...
    chipTheme: ChipThemeData(
      ...
      side: const BorderSide(color: AppColors.borderSurface, width: 0.5),
      shape: RoundedRectangleBorder(borderRadius: AppRadius.borderPill36),
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.selected)) {
          return AppTextStyles.pill.copyWith(color: AppColors.primary);
        }
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      shape: RoundedRectangleBorder(borderRadius: AppRadius.borderXs6),
    ),
    ...
    listTileTheme: ListTileThemeData(
      ...
      shape: const RoundedRectangleBorder(borderRadius: AppRadius.borderSm8),
    ),
