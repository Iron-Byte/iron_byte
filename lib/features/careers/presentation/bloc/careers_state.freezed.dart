...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CareersState);
}
...
/// @nodoc
class $CareersStateCopyWith<$Res>  {
$CareersStateCopyWith(CareersState _, $Res Function(CareersState) __);
}


/// Adds pattern-matching-related methods to [CareersState].
extension CareersStatePatterns on CareersState {
...
class _Initial implements CareersState {
  const _Initial();
...
class _Loading implements CareersState {
  const _Loading();
...
class _Loaded implements CareersState {
  const _Loaded();
...
class _Error implements CareersState {
...
@override
String toString() {
  return 'CareersState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CareersStateCopyWith<$Res> {
