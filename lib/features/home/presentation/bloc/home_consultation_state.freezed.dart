...
mixin _$HomeConsultationState {
 ...
 bool? get isServerOnline; ConsultationBookingStatus get bookingStatus; String? get bookingErrorMessage; ConsultationAttachment? get attachment; String? get attachmentErrorKey;
...
@override
int get hashCode => Object.hash(runtimeType,name,email,message,nameValidationError,emailValidationError,isServerOnline,bookingStatus,bookingErrorMessage,attachment,attachmentErrorKey);

@override
String toString() {
  return 'HomeConsultationState(name: $name, email: $email, message: $message, nameValidationError: $nameValidationError, emailValidationError: $emailValidationError, isServerOnline: $isServerOnline, bookingStatus: $bookingStatus, bookingErrorMessage: $bookingErrorMessage, attachment: $attachment, attachmentErrorKey: $attachmentErrorKey)';
}
...
@useResult
$Res call({
 String name, String email, String message, String? nameValidationError, String? emailValidationError, bool? isServerOnline, ConsultationBookingStatus bookingStatus, String? bookingErrorMessage, ConsultationAttachment? attachment, String? attachmentErrorKey
});
...
/// Create a copy of HomeConsultationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? email = null,Object? message = null,Object? nameValidationError = freezed,Object? emailValidationError = freezed,Object? isServerOnline = freezed,Object? bookingStatus = null,Object? bookingErrorMessage = freezed,Object? attachment = freezed,Object? attachmentErrorKey = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String email,  String message,  String? nameValidationError,  String? emailValidationError,  bool? isServerOnline,  ConsultationBookingStatus bookingStatus,  String? bookingErrorMessage,  ConsultationAttachment? attachment,  String? attachmentErrorKey)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeConsultationState() when $default != null:
return $default(_that.name,_that.email,_that.message,_that.nameValidationError,_that.emailValidationError,_that.isServerOnline,_that.bookingStatus,_that.bookingErrorMessage,_that.attachment,_that.attachmentErrorKey);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String email,  String message,  String? nameValidationError,  String? emailValidationError,  bool? isServerOnline,  ConsultationBookingStatus bookingStatus,  String? bookingErrorMessage,  ConsultationAttachment? attachment,  String? attachmentErrorKey)  $default,) {final _that = this;
switch (_that) {
case _HomeConsultationState():
return $default(_that.name,_that.email,_that.message,_that.nameValidationError,_that.emailValidationError,_that.isServerOnline,_that.bookingStatus,_that.bookingErrorMessage,_that.attachment,_that.attachmentErrorKey);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String email,  String message,  String? nameValidationError,  String? emailValidationError,  bool? isServerOnline,  ConsultationBookingStatus bookingStatus,  String? bookingErrorMessage,  ConsultationAttachment? attachment,  String? attachmentErrorKey)?  $default,) {final _that = this;
switch (_that) {
case _HomeConsultationState() when $default != null:
return $default(_that.name,_that.email,_that.message,_that.nameValidationError,_that.emailValidationError,_that.isServerOnline,_that.bookingStatus,_that.bookingErrorMessage,_that.attachment,_that.attachmentErrorKey);case _:
  return null;
...
class _HomeConsultationState implements HomeConsultationState {
  const _HomeConsultationState({this.name = '', this.email = '', this.message = '', this.nameValidationError, this.emailValidationError, this.isServerOnline, this.bookingStatus = ConsultationBookingStatus.idle, this.bookingErrorMessage, this.attachment, this.attachmentErrorKey});
...
/// Create a copy of HomeConsultationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? email = null,Object? message = null,Object? nameValidationError = freezed,Object? emailValidationError = freezed,Object? isServerOnline = freezed,Object? bookingStatus = null,Object? bookingErrorMessage = freezed,Object? attachment = freezed,Object? attachmentErrorKey = freezed,}) {
